        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-muted-foreground leading-relaxed">
              I’m an aspiring Full Stack Developer passionate about creating modern,
              responsive, and user-friendly web applications. I enjoy working on both the front-end and back-end to build complete digital solutions.
              With experience in technologies like React, JavaScript, Python, and SQL,
              I focus on developing clean, functional, and efficient applications.
              I am always eager to learn new tools and improve my skills to build
              better and more impactful software.
