...
const services = [
  ...
  },
  {
    ...
    description: "Building dynamic websites and web applications using PHP and MySQL.",
  },
  {
    icon: Rocket,
    title: "Full Stack Development",
    description: "End-to-end web solutions, from UI sparkle to server-side power.",
  },
];
