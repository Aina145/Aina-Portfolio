          ...
          >
            <div className="glass-card p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-foreground">hello@ainmalik.dev</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a href="#" className="glass-card p-4 hover:border-primary/50 transition-all text-muted-foreground hover:text-foreground">
                <Github size={20} />
              </a>
              <a href="#" className="glass-card p-4 hover:border-primary/50 transition-all text-muted-foreground hover:text-foreground">
                <Linkedin size={20} />
